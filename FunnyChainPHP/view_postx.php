...
<?php
  $title = "{$noti->titleNoti()} Post by {$universal->GETsDetails($post_by, "username")} • FunnyChain";
  $keywords = "FunnyChain, Share and capture world's moments, share, capture, view post";
