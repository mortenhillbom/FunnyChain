...
<?php
  $title = "FunnyChain";
  $keywords = "FunnyChain, Share and capture world's moments, share, capture, share, login, signup";
  $desc = "FunnyChain lets you capture, follow, like and share world's moments in a better way and tell your story with photos, messages, posts and everything in between";
?>
...
<div class="index_wrapper">
  ...
  <iframe src="https://ghbtns.com/github-btn.html?user=yTakkar&type=follow&count=false&size=large" frameborder="0" scrolling="0" width="180px" height="30px"></iframe>
    <iframe src="https://ghbtns.com/github-btn.html?user=yTakkar&repo=FunnyChain-Clone&type=fork&count=true&size=large" frameborder="0" scrolling="0" width="125px" height="30px"></iframe>
    <iframe src="https://ghbtns.com/github-btn.html?user=yTakkar&repo=FunnyChain-Clone&type=star&count=true&size=large" frameborder="0" scrolling="0" width="160px" height="30px"></iframe>
  </div>
  ...
  <div class="feature">
    <div class="feature_desc">
      ...
      <h3>FunnyChain helps you connect with people with your amazing photos, videos and everything in between.</h3>
