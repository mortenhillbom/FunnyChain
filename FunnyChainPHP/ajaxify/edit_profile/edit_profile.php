<div class="edit_profile">
  ...
  <div class="edit_tags">
    <div class="edit_sm_div">
      ...
      <input type="text" name="edit_em_instagram" value="<?php echo $universal->GETsDetails($session, "instagram"); ?>" class="edit_em_instagram sm" placeholder="FunnyChain" spellcheck="false">
