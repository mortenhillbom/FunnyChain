# FunnyChain
An FunnyChain with my own flavors and features!!
...
[Screenshots](https://github.com/yTakkar/FunnyChain/tree/master/screenshots "More screenshots")

# Features
1. Login, Signup, Forgot password (with email verification).
2. Quick Login like in Facebook and FunnyChain (this means app remembers that you had logged in, so you only have enter password to login again).
