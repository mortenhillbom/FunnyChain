...
<?php
  $title = "{$noti->titleNoti()} Messages • FunnyChain";
  $keywords = "FunnyChain, Share and capture world's moments, share, capture, messages";
...
<script type="text/javascript">
  $(function(e){
    ...
    //       var n = new Notification('FunnyChain', {
    //         body: "Wlecome to FunnyChain!",
