        ...
        while ($row = $query->fetch(PDO::FETCH_OBJ)) {
          ...
          echo "<div class='exp_finds_ph inst'>
            <div class='exp_f_ph_img'>
              <img src='{$this->DIR}/media/FunnyChain_{$image}' alt='' data-imgby='{$universal->GETsDetails($user, "username")}' data-postid='{$post}' data-time='{$Time->timeAgo($time)}' data-filter='{$filter}' class='{$filter}'>
            </div>
