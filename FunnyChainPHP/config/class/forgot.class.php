  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Team FunnyChain');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Team FunnyChain');
        ...
        $mail->Subject = 'Activate your FunnyChain account';

        $mail->Body = "<span>Hello, You received this message because you created an account on INSTAGRAM.<span><br>
        <span>Click on button below to retrieve your FunnyChain account and explore.</span><br><br>
