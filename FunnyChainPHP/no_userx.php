...
<?php
  $title = "{$noti->titleNoti()} Member not found • FunnyChain";
  $keywords = "eror, 404, document not found, webpage not found, FunnyChain, Share and capture world's moments";
  $desc = "There's been an error • FunnyChain";
?>
